  ...
  USERS: [
    {
      ...
      id: 'oz6X16KhCVM0wM-Xib9-lvFYeR0k',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'Crkp5E_E7uhYxzFGskTNKNSDMrTmHtB-KgARd3bvIS0',
      // 所在省份
      province: '广东',
      // 所在城市
      city: '广州',
      ...
      festivals: [
        ...
        {
          type: '*生日', name: '老婆', year: '1995', date: '02-23',
        },
        {
          type: '节日', name: '恋爱周年纪念日', year: '2020', date: '05-23',
        },
      ...
      customizedDateList: [
        // 在一起的日子
        { keyword: 'love_day', date: '2020-02-23' },
        // 纪念日
